...
namespace Kardinal.Net.Data
{
    ...
    {        
        ...
        public static PropertyBuilder<TProperty> IsProtected<TProperty>(this PropertyBuilder<TProperty> builder, RSAParameters parameters)
        {
            var provider = new DefaultDataProtectionProvider(parameters);
            return builder.IsProtected<TProperty, InternalDataProtectionFailSafeProvider>(provider);
        }
