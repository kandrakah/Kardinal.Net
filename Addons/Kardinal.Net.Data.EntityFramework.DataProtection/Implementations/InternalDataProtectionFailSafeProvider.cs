...
{
    internal sealed class InternalDataProtectionFailSafeProvider : IDataProtectionFailSafeProvider
    {
        /// <summary>
        ...
        public string OnProtectFail<T>(Exception ex)
        {
            throw new DataProtectionException(ex.Message, ex);
        }
        ...
        /// <returns>Resultado do tratamento da exceção.</returns>
        public T OnUnprotectFail<T>(Exception ex)
        {
            throw new DataProtectionException(ex.Message, ex);
        }
    }
